...
df = spgan_wrapper.build_dataset("data/raw_data.csv", rows=101, neighbours=50, output_vars="salinity")
# plot(self, img_name, title, generated_seq, dataframe=None): #haven't decided if i need this & don't know how to write this neatly
